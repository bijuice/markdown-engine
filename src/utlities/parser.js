...
export const htmlMarkdownEngine = (input) => {
  //headings
  input = input
  ...
  input = input.replace(regexValues.imageValues, `<img src=$2 alt="$1"> $3 \n`);
  ...
  //blockquote
  input = input.replace(regexValues.blockquote, `<blockquote>$1</blockquote>`);
...
export const latexMarkdownEngine = (input) => {
  //headings
  input = input
  ...
  //unordered list item
  input = input.replace(regexValues.firstUnorderedItem, `begin{enumerate}\n$1`);
